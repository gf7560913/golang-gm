...
//国密
#define CKM_SM2_DSA					   0x80008200
#define CKM_SM2_SHA_1                  0x80008300

#define CKM_SM2						   (CKM_VENDOR_DEFINED + 0x8000)
#define CKM_SM2_KEY_PAIR_GEN		   (CKM_SM2 + 0x00000001)
#define CKM_SM3_SM2					   0x80008100
#define CKM_SM3_SM2_SJ				   0x80008101
#define CKM_SM2_RAW					   0x80008200
#define CKM_SM2_DERIVE                 0x80008301

// 国富安
#define CKK_SM2						   (0x80000004)

#define CKM_SM3						   (CKK_VENDOR_DEFINED + 5)
#define CKM_SM3_UID					   (CKK_VENDOR_DEFINED + 6)
#define CKM_SM3_HMAC				   (CKK_VENDOR_DEFINED + 7)
#define CKM_SM3_HMAC_GENERAL		   (CKK_VENDOR_DEFINED + 8)

#define CKK_SM4                        CKK_VENDOR_DEFINED + 2
#define CKM_SM4_KEY_GEN                0x80000107
#define CKM_SM4_ECB                    0x80000108
#define CKM_SM4_CBC                    0x80000109
#define CKM_SM4_MAC                    0x8000010A
#define CKM_SM4_MAC_GENERAL            0x8000010B
#define CKM_SM4_CBC_PAD                0x8000010C
#define CKM_PBE_MD5_SM4_CBC            0x8000010D
#define CKM_PBE_SHA1_SM4_CBC           0x8000010E
