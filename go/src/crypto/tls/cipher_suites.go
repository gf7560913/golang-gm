...
func CipherSuites() []*CipherSuite {
	return []*CipherSuite{
		...
		//added by xy
		{TLS_ECDHE_SM2_WITH_SMS4_SM3, "TLS_ECDHE_SM2_WITH_SMS4_SM3", supportedOnlyTLS12, false},
		{TLS_ECDHE_SM2_WITH_SMS4_GCM_SM3, "TLS_ECDHE_SM2_WITH_SMS4_GCM_SM3", supportedOnlyTLS12, false},
...
var cipherSuites = []*cipherSuite{
	...
	//added by xy
	{TLS_ECDHE_SM2_WITH_SMS4_SM3, 16, 32, 16, ecdheSM2, suiteECDHE | suiteSM2 | suiteTLS12, cipherSM4, macSM3, nil},
	{TLS_ECDHE_SM2_WITH_SMS4_GCM_SM3, 16, 0, 4, ecdheSM2, suiteECDHE | suiteSM2 | suiteTLS12, nil, nil, aeadSM4GCM},
}
...
//added by heli
func aeadSM4GCM(key, fixedNonce []byte) aead {
	sms4, err := sm4.NewCipher(key)
	if err != nil {
		panic(err)
	}
	aead, err := cipher.NewGCM(sms4)
	if err != nil {
		panic(err)
	}
...
//added by yj
func ecdheSM2(version uint16) keyAgreement {
	return &ecdheKeyAgreement{
...
const (
	...
	//added by yj
	TLS_ECDHE_SM2_WITH_SMS4_SM3             uint16 = 0xE102	//0xccaa
	//added by heli
	TLS_ECDHE_SM2_WITH_SMS4_GCM_SM3			uint16 = 0xE107
